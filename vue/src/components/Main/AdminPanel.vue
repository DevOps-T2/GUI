    ...
    <div class="mt-4 mb-4 col-span-2">
        ...
        <div class="text-left w-full pl-40 mt-36 ml-auto mr-auto">
            ...
            <div class="borderShadowProject rounded-sm tracking-wide">
                <div class="mt-4 flex flex-wrap text-center text-white text-tableCells font-medium  pl-16 py-6 bg-white marginBottom ">

                    <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="md:col-span-1">
                            <div class="px-4 sm:px-0">
                                <h3 class="text-lg font-medium leading-6 text-gray-900">Solver</h3>
                                <p class="mt-1 text-sm text-gray-600">
                                    Here you can configure and upload your solver file. Maximum size is 50MB.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="mt-10 sm:mt-0">
                        <div class="md:grid md:grid-cols-3 md:gap-6">
                            <div class="md:col-span-1">
                                <div class="px-4 sm:px-0">
                                    <h3 class="text-lg font-medium leading-6 text-gray-900">Resource allocation</h3>
                                    <p class="mt-1 text-sm text-gray-600">
                                        Here you can configure resource allocation.  Here you can configure resource allocation.
                                    </p>
                                </div>
                            </div>
                            <div class="mt-5 md:mt-0 md:col-span-2">
