    ...
    <div class="ml-2 flex flex-col h-screen pb-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600 left-0 bg-white">
      ...
      <div style="height: 100%;" class="flex flex-col justify-between flex-1 mt-1 relative h-full">
        <nav class="">
          ...
          <router-link :to="{ name: 'Dashboard' }" class="flex items-center  py-2  text-gray-600 transition-colors duration-200 transform dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
